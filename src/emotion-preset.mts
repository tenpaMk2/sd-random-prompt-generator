...
export const emotionPreset = {
  ...
  fangAll: [Object.values(fangPreset).map((p) => ({ entries: p }))],
  chisato: [
    [
  ...
  cuteFang: [
    [
      { entries: fangPreset.smileClosedMouth },
      { entries: fangPreset.smileOpenMouthWithFang },
      { entries: fangPreset.smileOpenMouthWithFang },
      { entries: fangPreset.smileOpenMouthWithFang },
      { entries: fangPreset.smileHalfClosedEyes },
      { entries: fangPreset.expressionless },
      { entries: fangPreset.surprised },
      { entries: fangPreset.confused },
      { entries: fangPreset.embarrassed },
      { entries: fangPreset.nervous },
      { entries: fangPreset.flustered },
      { entries: fangPreset.seductiveSmile },
      { entries: fangPreset.seductiveSmileWithFang },
      { entries: fangPreset.seductiveSmileWithFang },
      { entries: fangPreset.seductiveSmileWithFang },
      { entries: fangPreset.naughtyFace },
      { entries: fangPreset.oneEyeClosedWithFang },
      { entries: fangPreset.oneEyeClosedWithFang },
    ],
  ],
} as const satisfies { [k: string]: Entry<EmotionTag>[] };
