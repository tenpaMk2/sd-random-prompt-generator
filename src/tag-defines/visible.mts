...
export const tagVisibilities = {
  ...
  "flat chest": visibleType.breastSize,
  "small breasts": visibleType.breastSize,
  "medium breasts": visibleType.breastSize,
  "large breasts": visibleType.breastSize,
  "huge breasts": visibleType.breastSize,
  "cat tail": visibleType.tail,
  "dog tail": visibleType.tail,
  "fox tail": visibleType.tail,
  "thick thighs": visibleType.thigh,
  "wide hips": visibleType.tail,
  ...
  breasts: { ...invisible, frontPortrait: true, sidePortrait: true },
  sideboob: { ...invisible, sidePortrait: true },
  backboob: { ...invisible, backPortrait: true },
  "hanging breasts": visibleType.breastSize,
  ...
  "zettai ryouiki": visibleType.all,
  "thigh gap": visibleType.all,
  ...
  bikini: visibleType.totalOutfit,
  "blue bikini": visibleType.totalOutfit,
  "frilled bikini": visibleType.totalOutfit,
  "school uniform": visibleType.totalOutfit,
  "white jacket": visibleType.shirt,
  "white dress": visibleType.totalOutfit,
  ...
  "maid bikini": visibleType.totalOutfit,
  frills: visibleType.all,
  apron: visibleType.totalOutfit,
  "frilled apron": visibleType.totalOutfit,
  "maid apron": visibleType.totalOutfit,
  ...
  dress: visibleType.totalOutfit,
  "red dress": visibleType.totalOutfit,
  "black dress": visibleType.totalOutfit,
  "grey dress": visibleType.totalOutfit,
  "two-tone dress": visibleType.totalOutfit,
  "off shoulder": visibleType.shirt,
  "off-shoulder dress": visibleType.totalOutfit,
  "off-shoulder sweater": visibleType.shirt,
  sweater: visibleType.shirt,
  "red sweater": visibleType.shirt,
  "sweater dress": visibleType.totalOutfit,
  ...
  "pleated dress": visibleType.totalOutfit,
  ...
  "crotch seam": visibleType.upskirt,
  "lace panties": visibleType.panty,
  "chino work": visibleType.all,
  aachisato: visibleType.all,
  // Emotion
  blush: visibleType.all,
  "nose blush": visibleType.all,
  smile: visibleType.all,
  "light smile": visibleType.all,
  "parted lips": visibleType.all,
  ":d": visibleType.all,
  ";d": visibleType.all,
  ":\\)": visibleType.all,
  ";\\)": visibleType.all,
  ":o": visibleType.all,
  ";o": visibleType.all,
  "open mouth": visibleType.all,
  "closed mouth": visibleType.all,
  "half-closed eyes": visibleType.all,
  expressionless: visibleType.all,
  surprised: visibleType.all,
  embarrassed: visibleType.all,
  nervous: visibleType.all,
  flustered: visibleType.all,
  "naughty face": visibleType.all,
  scowl: visibleType.all,
  "one eye closed": visibleType.all,
  profile: visibleType.all,
  // Arm pose
  "arms up": visibleType.arm,
  "arm up": visibleType.arm,
  "w arms": visibleType.arm,
  "reaching towards viewer": visibleType.arm,
  v: visibleType.arm,
  "hand up": visibleType.arm,
  "hands on own chest": visibleType.arm,
  "heart hands": visibleType.arm,
  "own hands together": visibleType.arm,
  singing: visibleType.arm,
  "holding microphone": visibleType.arm,
  // Pose
  "looking at viewer": visibleType.all,
  "looking back": visibleType.all,
  "looking up": visibleType.all,
